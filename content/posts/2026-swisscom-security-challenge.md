...
images = [
    "/images/posts/2026-swisscom-challenge-cover.png"
]
tags = [
    "security",
    "security.txt",
...
>
> Keep at it. My colleagues are looking forward to a response with the correct address or answer. 😊
> 
> And as background info: we're already preparing the next puzzle.
> So it's worth checking out the security.txt file again in 2024.
> 
...
However, I was determined to break this streak in 2026. After two consecutive years of missed opportunities, I committed to tackling the puzzle early and dedicating the necessary time to see it through. What followed was a weekend journey filled with learnings, persistence, and finally - a flag to submit. 

Within days of my submission, I received this confirmation:
...
<video width="100%" controls>
  <source src="/images/posts/2026-swisscom-challenge-video.mp4" type="video/mp4">
